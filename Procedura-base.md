...
## SHORTCUT
1. Creazione model, controller risorsa, migration, seeder con shortcut  <br>
    ``` php artisan make:model Models/NomeModello -msr ```

2. Creazione model, controller normale, migration, seeder con shortcut <br>
...
2. YELD, viene usato in specifiche sezioni del LAYOUT, cosi che quando si richiama quel layoutsi possa modificare dinamicamente quella parte di yeld, e farla diversa ogni volta che si richiama quel layout <br>
    ``` @yield('nomeYeld') ```
